...
module.exports = {
  ...
  //
  // debug: true, 
  // patch_require: this option is monkey patching node
  // to add support for require.context which is a webpack specific method.
  patch_require: true,
  assets: {
    images: {
      extensions: [
    ...
    // './src/styles/bootstrap/config.js' file.
